<!--[346,1,680] published at 2008-11-25 18:13:17 from #221 by 1430-->
/**---------------------------------------------------------------------------
* browser determine;
*/
...
var $config={
	...
	right			: 10,
	display			: true,
	contentUrl		: "http://bbs.sina.com.cn/tuijian/gundong.html",
	time : {
		slideIn			: 10,
		hold			: 10,
		slideOut		: 10
...
function PopUp(id, config){
	...
	this.imgMin = "http://i3.sinaimg.cn/blog/mini/08olympic/blogrecommend_hz_004.gif";
	this.imgMax = "http://i2.sinaimg.cn/blog/mini/08olympic/blogrecommend_hz_003.gif";
}
	...
	create : function (){
		...
		*/
		...
		var html = "<a id='closeButton' href='#'></a>"+
					"<a id='switchButton' href='#'></a>"+
					"<div id='ifm_div'><iframe id='"+this.id+"_content_iframe' src="+c.contentUrl+" frameborder=0 scrolling=no width='100%' height='100%'></iframe></div>";
